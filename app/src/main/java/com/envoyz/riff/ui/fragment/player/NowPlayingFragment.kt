...
import com.envoyz.riff.adapter.artist.SeeArtistOfNowPlayingAdapter
import com.envoyz.riff.adapter.lyrics.LyricsAdapter
import com.envoyz.riff.adapter.playlist.AddToAPlaylistAdapter
import com.envoyz.riff.common.Config
import com.envoyz.riff.common.Config.ALBUM_CLICK
import com.envoyz.riff.common.Config.MINIPLAYER_CLICK
import com.envoyz.riff.common.Config.PLAYLIST_CLICK
import com.envoyz.riff.common.Config.SHARE
...
import com.envoyz.riff.data.model.metadata.MetadataSong
import com.envoyz.riff.data.queue.Queue
import com.envoyz.riff.databinding.BottomSheetAddToAPlaylistBinding
import com.envoyz.riff.databinding.BottomSheetNowPlayingBinding
import com.envoyz.riff.databinding.BottomSheetSeeArtistOfNowPlayingBinding
import com.envoyz.riff.databinding.BottomSheetSleepTimerBinding
import com.envoyz.riff.databinding.FragmentNowPlayingBinding
import com.envoyz.riff.extension.connectArtists
import com.envoyz.riff.extension.navigateSafe
import com.envoyz.riff.extension.removeConflicts
...
import com.envoyz.riff.service.RepeatState
import com.envoyz.riff.service.test.download.MusicDownloadService
import com.envoyz.riff.utils.CenterLayoutManager
import com.envoyz.riff.utils.DisableTouchEventRecyclerView
import com.envoyz.riff.utils.InteractiveTextMaker
import com.envoyz.riff.utils.Resource
import com.envoyz.riff.viewModel.LyricsProvider
